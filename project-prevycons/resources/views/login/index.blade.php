...
<div class="container flex flex-col w-11/12 sm:w-3/5 text-center mx-auto h-auto">
    ...
    <form action="" class="">
        ...
        <div class="m-3">
            <input type="email" name="correo" class="form-input w-7/12 py-2 text-xl rounded-md bordeazul font-black tracking-wide" placeholder="Correo Electrónico">
        </div>

        <div class="relative m-3">
            <input type="password" name="contraseña" class="form-input w-7/12 py-2 text-xl rounded-md relative bordeazul font-black tracking-wide" placeholder="Contraseña">
        ...
        <div class="text-center text-slate-500 my-12 divide-y-4 divide-x-52 divide-slate-300 ">
            <a href="" class="font-black text-xl text-center text-white bg-blue-600  py-2 px-8 sm:px-32 rounded-full tracking-wide">Iniciar sesión</a>            
        </div>
        
        <div class="linea w-4/6"></div>

        <div class="text-slate-400 text-center text-xl mt-8 flex justify-center space-x-2">
        ...
        <div class="text-slate-400 text-center mt-2 flex justify-center space-x-1">
            ...
            <img src="img/login/Icono Salir Gris.png" class="w-4 h-4" alt="">
        </div>
    </form>
