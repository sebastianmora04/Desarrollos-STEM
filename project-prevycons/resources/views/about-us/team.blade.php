...
@section('content')
    ...
    <div class="md:w-10/12 mx-auto">
        <div class="flex flex-col  mx-auto h-auto sm:text-2xl text-xl  underline underline-offset-8 text-gray-500">
            <div class="m-auto">
                NUESTRO EQUIPO
            </div>
        </div>
        <br>
        <p class="bg-emerald-600 text-slate-50 p-4 md:p-2 md:px-2 sm:w-3/4 w-11/12 mx-auto text-justify sm:text-base text-sm">
    ...
    <div class="md:grid md:grid-cols-2 gap-4  h-auto w-full p-4 justify-center mx-auto shadow-xl ">
        ...
        <div class="box-border h-auto p-4 shadow-lg hover:shadow-2xl w-auto">
            <div class="flex flex-row">
                ...
                <div class="basis-4/6 sm:text-base text-sm">
                    <br><br>
            ...
            <br>
            <p class="mx-auto text-justify sm:text-base text-sm">
