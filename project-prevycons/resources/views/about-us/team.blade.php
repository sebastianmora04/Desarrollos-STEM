...
@section('content')
    ...
    <div class="md:w-10/12 mx-auto">
        <div class="flex flex-col mx-auto h-auto sm:text-5xl text-3xl w-10/12">
    ...
    <div class="sm:grid sm:grid-cols-2 w-11/12 mx-auto">
        <img class="sm:w-1/2 w-full col-span-1" src="" alt="">
        <div class="px-4">
            <h2 class="titulos lg:text-5xl md:text-4xl text-3xl azul2">Susana <br> Prada Robayo</h2>
            <br>
            <h4 class="lg:text-lg font-bold">Ing. Industrial - Esp. en Salud Ocupacional.</h4>
            <br>
            <h4 class="sm:text-base text-sm text-justify">
    ...
    <div class="sm:grid sm:grid-cols-2 w-11/12 mx-auto">
        <img class="sm:w-1/2 w-full col-span-1" src="" alt="">
        <div class="px-4">
            <h2 class="titulos lg:text-5xl md:text-4xl text-3xl azul2">Tatiana <br> Castañeda Sánchez</h2>
            <br>
            <h4 class="lg:text-lg font-bold">Ing. Ambiental - Mag. en Calidad y Gestión Integral.</h4>
            <br>
            <h4 class="sm:text-base text-sm text-justify">
    ...
    <div class="sm:grid sm:grid-cols-2 w-11/12 mx-auto">
        <img class="sm:w-1/2 w-full col-span-1" src="" alt="">
        <div class="px-4">
            <h2 class="titulos lg:text-5xl md:text-4xl text-3xl azul2">Olga Lucia <br> Mantilla Q.</h2>
            <br>
            <h4 class="lg:text-lg font-bold">Psicologa - Esp. en Salud Ocupacional.</h4>
            <br>
            <h4 class="sm:text-base text-sm text-justify">
    ...
    <div class="sm:grid sm:grid-cols-2 w-11/12 mx-auto">
        ...
        <div class="px-4">
            ...
            <br>
            <h4 class="lg:text-lg font-bold">Fisioterapeuta - Esp. en Seguridad y Salud en el Trabajo.</h4>
            <br>
            <h4 class="sm:text-base text-sm text-justify">
    ...
    <div class="grid grid-cols-2 gap-4  h-auto sm:w-2/3 w-full p-4 justify-center mx-auto">
        <a href="{{route('about.index')}}" class="box-border lg:h-[124] md:h-[148px] h-[132px] p-4 shadow-lg hover:shadow-2xl w-full m-auto rounded bg-blue-200">
