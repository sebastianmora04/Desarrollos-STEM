...
<body class="bg-gradient-to-t from-[#001559] to-blue-700 text-[#e9f1f4]">
    ...
    <header class="hidden lg:block container-fluid  position-sticky top-0 px-14 text-[#e9f1f4] titulos">
        <div class="items-center justify-between flex px-15 py-4 my-4 mx-auto w-full">
            ...
            <div class="flex">
                <ul class="flex nav">
                    <li class="ml-5 px-1 py-1 transition  hover:scale-105 hover:text-white hover:underline-offset-2 hover:underline ease-in-out rounded"><a class="font-black" href="{{route('home.index')}}">Inicio</a></li>
                    ...
                    <li class="ml-5 px-1 py-1 transition  hover:scale-105 hover:text-white hover:underline-offset-2 hover:underline ease-in-out rounded">
                        ...
                        <ul class="filtro1 px-auto bg-transparent text-blue-700 rounded text-sm shadow-xl">
                            <li class="invisible"><br> space <br></li>
                            <li class="text-sm font-semibold px-1 border-2 bgslatemenu">Sistemas de gestión</li>
                            ...
                            <li class="text-sm font-semibold px-1 border-2 bgslatemenu">Otros servicios</li>
    ...
    <footer class="azul1">
        ...
        <br>
        <p class=" m-auto text-center text-xs space-x-1"> <a href="{{route('about.index')}}">NOSOTROS</a>  |<a href="{{route('servicios.index')}}">SERVICIOS</a>  |<a href="{{route('hire.index')}}">CONTACTO</a></p>
        <br>
        <!-- redes sociales -->
