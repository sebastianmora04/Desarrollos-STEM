...
class ServicioSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $servicio->img="img/gestioncalidad.jpg";
        $servicio->save();
        ...
        $servicio2->img="img/gestionsst.jpg";
        $servicio2->save();
        ...
        $servicio3->img="img/gestiondocumental.jpg";
        $servicio3->save();
        ...
        $servicio4->img="img/gestionambiental.jpg";
        $servicio4->save();
        ...
        ';
        $servicio6->img="img/auditorias.jpg";
        $servicio6->save();
        ...
        ';
        $servicio8->img="img/reporteincidentes.jpg";
        $servicio8->save();
